...
if (cronConfig.interval) {
  cron.schedule(cronConfig.interval, function () {
    getForecast()
  })
  console.log(`DarkSky data will be written to InfluxDB at cron interval '${cronConfig.interval}'`)
} else {
  getForecast()
  console.log('DarkSky data was written to InfluxDB once')
}
